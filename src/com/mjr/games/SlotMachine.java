...
public class SlotMachine {
	...
	if (type == BotType.Twitch)
	    return new ResultPair(emotesTwtich[slot1] + " " + emotesTwtich[slot2] + " " + emotesTwtich[slot2],
		    slot1 == slot2 && slot1 == slot3 ? true : false);
	else
	    return new ResultPair(emotesMixer[slot1] + " " + emotesMixer[slot2] + " " + emotesMixer[slot2],
		    slot1 == slot2 && slot1 == slot3 ? true : false);
