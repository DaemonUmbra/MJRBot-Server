...
public class ConsoleUtil {
	...
	if (MessageType == "Chat") {
		...
		if (Permissions.hasPermission(type, channel, sender, PermissionLevel.Bot.getName())) {
		    ...
		    System.out.println("\n" + "[Bot Type]" + type.getTypeName() + " [Channel]" + channel + " [Streamer]" + sender
			    + ": " + message);
		    ...
		    System.out.println("\n" + "[Bot Type]" + type.getTypeName() + " [Channel]" + channel + " [Bot Owner]" + sender
			    + ": " + message);
		} else if (Permissions.hasPermission(type, channel, sender, PermissionLevel.Moderator.getName())) {
		    System.out.println("\n" + "[Bot Type]" + type.getTypeName() + " [Channel]" + channel + " - [Moderator]" + sender
			    + ": " + message);
