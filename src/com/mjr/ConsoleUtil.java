...
public class ConsoleUtil {
    ...
    public static void TextToConsole(Object bot, String message, String channel, String MessageType, String sender) {
	TextToConsole(bot, null, channel, message, MessageType, sender);
    }

    public static void TextToConsole(Object bot, BotType type, String channel, String message, String MessageType, String sender) {
	if (MessageType == "Chat") {
	    if (sender != null) {
