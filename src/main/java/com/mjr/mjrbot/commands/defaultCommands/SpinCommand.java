	...
	public void onCommand(BotType type, Object bot, String sender, String login, String hostname, String message, String[] args) {
		if (ChannelConfigManager.getSetting("Games", type, bot).equalsIgnoreCase("true")) {
			if (PointsSystemManager.hasPoints(sender, 1, type, bot)) {
				...
				if (result.hasWon()) {
					MJRBotUtilities.sendMessage(type, bot, "@" + sender + " " + result.getResult() + " you have Won! You have been given " + PointsSystemManager.AddRandomPoints(sender, type, bot) + " Points");
