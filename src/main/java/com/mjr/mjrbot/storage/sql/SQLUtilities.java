...
public class SQLUtilities {
	...
	public static void createDatabaseStructure() {
		...
		if (MJRBot.storageType == StorageType.Database) {
			...
			MySQLConnection.executeUpdate(
					"CREATE TABLE mjrbot.tokens (id int(50) not null auto_increment primary key, channel varchar(35), access_token varchar(100), refresh_token varchar(100), platform varchar(10), channel_id int(20), expires_in int(12), last_login datetime");
			MySQLConnection
