...
public class PUBG {
	...
	public static String replaceVariablesWithData(String variable) {
		...
		if (!pubgParts[0].equalsIgnoreCase("steam"))
			...
			if (!pubgParts[2].equalsIgnoreCase("duo") && !pubgParts[2].equalsIgnoreCase("duo-fpp") 
					&& !pubgParts[2].equalsIgnoreCase("solo") && !pubgParts[2].equalsIgnoreCase("solo-fpp") 
					&& !pubgParts[2].equalsIgnoreCase("squad") && !pubgParts[2].equalsIgnoreCase("squad-fpp"))
