...
public class SQLUtilities {
	...
	public static void createDatabaseStructure() {
		...
		if (MJRBot.storageType == StorageType.Database) {
			...
			MySQLConnection.executeUpdate("CREATE TABLE mjrbot.badwords (id int(50) not null auto_increment primary key, channel varchar(35), word varchar(35), twitch_channel_id int(20))");
		}
	}
