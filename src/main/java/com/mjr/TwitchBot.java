...
public class TwitchBot extends PircBot {
	...
	public void init(String channelName) {
		...
		ConsoleUtil.textToConsole(this, BotType.Twitch, this.channelName, "Joined " + this.channelName.substring(this.channelName.indexOf("#") + 1) + " channel", MessageType.Bot, null);
	...
	protected void onNotice(String sourceNick, String sourceLogin, String sourceHostname, String target, String notice) {
		...
		if (notice.contains("The moderators of this channel are:")) {
			try {
				...
				ConsoleUtil.textToConsole(this, BotType.Twitch, this.channelName, "There was a problem getting the moderators of this channel!", MessageType.Bot, null);
			}
			if (moderators == null) {
				ConsoleUtil.textToConsole(this, BotType.Twitch, this.channelName, "There was a problem getting the moderators of this channel!", MessageType.Bot, null);
				return;
	...
	public void ConnectToTwitch() throws IOException {
		if (!ConfigMain.getSetting("TwitchUsername").equals("") && !ConfigMain.getSetting("TwitchPassword").equals("") && !(ConfigMain.getSetting("TwitchUsername") == null) && !(ConfigMain.getSetting("TwitchPassword") == null)) {
			if (!this.ConnectedToChannel) {
				...
				ConsoleUtil.textToConsole(this, BotType.Twitch, this.channelName, "Your already connected using these login details!", MessageType.Bot, null);
				return;
			}
		...
		if (this.isConnected()) {
			...
			ConsoleUtil.textToConsole(this, BotType.Twitch, this.channelName, "Connection to Twitch failed, check your login details!", MessageType.Bot, null);
	}
